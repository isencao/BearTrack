      ...
      <div className="max-w-3xl mx-auto space-y-6 animate-fade-in">
        ...
        <header className="flex flex-col space-y-6 pb-6 border-b border-zinc-800/50 mb-6">
          <div className="flex justify-between items-center w-full gap-2">
            ...
            <div className="flex items-center gap-2 md:gap-4 bg-zinc-900/50 border border-zinc-800/80 px-3 py-2 md:px-6 md:py-3.5 rounded-xl md:rounded-[1.5rem] shadow-inner group transition-all hover:border-red-600/40 flex-shrink min-w-0">
              <div className="relative flex items-center justify-center flex-shrink-0">
                <div className="w-1.5 h-1.5 md:w-2.5 md:h-2.5 bg-red-600 rounded-full animate-pulse"></div>
                <div className="absolute inset-0 w-1.5 h-1.5 md:w-2.5 md:h-2.5 bg-red-600 rounded-full blur-md opacity-60"></div>
              </div>
              <div className="flex flex-col text-right min-w-0">
                <span className="text-[6px] md:text-[10px] text-zinc-500 font-black uppercase tracking-[0.2em] leading-none mb-1 md:mb-1.5 truncate">
                  SİSTEM AKTİF
                </span>
                <span className="text-[9px] md:text-base text-white font-black uppercase tracking-tighter truncate">
                  HOŞ GELDİN, <span className="text-red-600 group-hover:text-red-500 transition-colors">{username}</span>
                </span>
              </div>
            </div>
          </div>
